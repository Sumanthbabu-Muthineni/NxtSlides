...
import NewSlidesBtn from './components/NewSlidesBtn'
...
class App extends Component {
  ...
  addNewItem = item => {
    ...
    this.setState(prevState => {
      const {initialList} = prevState
      const newList = [...initialList] // Create a copy of the array to avoid mutating the original
      newList.splice(activeIndex + 1, 0, item) // Insert the new item at activeIndex + 1
      return {initialList: newList}
    })
  }
